...
// Jika Anda punya shapefile batas IKN di Assets, ganti baris ini:
// var iknBoundary = ee.FeatureCollection("projects/YOUR_PROJECT/assets/IKN_Boundary");
// Sebagai placeholder, kita buat kotak area (bounding box) di sekitar IKN (Penajam Paser Utara):
...
Map.addLayer(iknBoundary, {color: 'red'}, 'Batas IKN (Placeholder)', false);
